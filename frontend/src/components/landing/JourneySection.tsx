    ...
    <section className="bg-white border-y border-slate-100 py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <p className="text-center text-xs font-semibold uppercase tracking-widest text-slate-400 mb-8">
          The complete connected healthcare journey
        </p>
          ...
          {JOURNEY_STEPS.map((step, i) => (
            <div key={step.label} className="flex items-center gap-2 sm:gap-0">
              <div className="flex flex-col items-center gap-2 px-4 sm:px-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-teal-50 text-teal-600 border border-teal-100">
                  {step.icon}
                </div>
                <span className="text-xs font-semibold text-slate-600">{step.label}</span>
              </div>
              {i < JOURNEY_STEPS.length - 1 && (
                <div className="hidden sm:flex items-center text-teal-300 mx-1">
